...
// PutMmdsParams contains all the bound params for the put mmds operation
// typically these are obtained from a http.Request
//
// swagger:parameters putMmds
...
//
// To ensure default values, the struct must have been initialized with NewPutMmdsParams() beforehand.
func (o *PutMmdsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
