...
func (m *SnapshotLoadParams) UnmarshalJSON(data []byte) error {
	var props struct {
	...
	m.EnableDiffSnapshots = props.EnableDiffSnapshots
	m.MemBackend = props.MemBackend
	m.MemFilePath = props.MemFilePath
	m.NetworkOverrides = props.NetworkOverrides
	m.ResumeVM = props.ResumeVM
	m.SnapshotPath = props.SnapshotPath
	return nil
}
