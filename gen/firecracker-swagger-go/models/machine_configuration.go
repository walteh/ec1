...
func (m *MachineConfiguration) UnmarshalJSON(data []byte) error {
	var props struct {
	...
	m.CPUTemplate = props.CPUTemplate
	m.HugePages = props.HugePages
	m.MemSizeMib = props.MemSizeMib
	m.Smt = props.Smt
	m.TrackDirtyPages = props.TrackDirtyPages
	m.VcpuCount = props.VcpuCount
	return nil
}
