...
func (m *Drive) UnmarshalJSON(data []byte) error {
	var props struct {
	...
	m.CacheType = props.CacheType
	m.DriveID = props.DriveID
	m.IoEngine = props.IoEngine
	m.IsReadOnly = props.IsReadOnly
	m.IsRootDevice = props.IsRootDevice
	m.Partuuid = props.Partuuid
	m.PathOnHost = props.PathOnHost
	m.RateLimiter = props.RateLimiter
	m.Socket = props.Socket
	return nil
}
