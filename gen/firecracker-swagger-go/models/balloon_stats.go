...
func (m *BalloonStats) UnmarshalJSON(data []byte) error {
	var props struct {
	...
	m.ActualMib = props.ActualMib
	m.ActualPages = props.ActualPages
	m.AvailableMemory = props.AvailableMemory
	m.DiskCaches = props.DiskCaches
	m.FreeMemory = props.FreeMemory
	m.HugetlbAllocations = props.HugetlbAllocations
	m.HugetlbFailures = props.HugetlbFailures
	m.MajorFaults = props.MajorFaults
	m.MinorFaults = props.MinorFaults
	m.SwapIn = props.SwapIn
	m.SwapOut = props.SwapOut
	m.TargetMib = props.TargetMib
	m.TargetPages = props.TargetPages
	m.TotalMemory = props.TotalMemory
	return nil
}
