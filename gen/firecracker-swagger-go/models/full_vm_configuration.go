...
func (m *FullVMConfiguration) UnmarshalJSON(data []byte) error {
	var props struct {
	...
	m.Balloon = props.Balloon
	m.BootSource = props.BootSource
	m.CPUConfig = props.CPUConfig
	m.Drives = props.Drives
	m.Entropy = props.Entropy
	m.Logger = props.Logger
	m.MachineConfig = props.MachineConfig
	m.Metrics = props.Metrics
	m.MmdsConfig = props.MmdsConfig
	m.NetworkInterfaces = props.NetworkInterfaces
	m.Vsock = props.Vsock
	return nil
}
